    ...
    layout = [
        ...
        sg.Column(
            [
                ...
                [sg.Text("Total de Consultas: 50", font="Arial 15", text_color=TEXTO, background_color=FUNDO, justification='left', expand_x=True)],
                [sg.Text("Consultas Pendentes: 10", font="Arial 15", text_color=TEXTO, background_color=FUNDO, justification='left', expand_x=True)],
                [sg.Text("Consultas Concluídas: 40", font="Arial 15", text_color=TEXTO, background_color=FUNDO, justification='left', expand_x=True)],
            ],
            background_color=FUNDO,
            element_justification="center",
            vertical_alignment="top",
...
def layout_gerir_consultas():
    window_size = sg.Window.get_screen_size()
    layout = [
        [sg.Button("✕", key="sair", button_color=("white", "#FF0000"), size=(4, 2), font="Arial 16")]
        # ...existing code...
    ]
    return sg.Window("Gestão de Consultas", layout, size=window_size, no_titlebar=True, background_color=FUNDO, margins=(0,0))
